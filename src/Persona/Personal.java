...
public class Personal extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String contra = jTextField10.getText();
        String cuenta = jTextField12.getText();
        ...
        try{
            ...
            String sql = "INSERT INTO persona VALUES('"+rfc1+"', '"+curp1+"', "
            + "'"+name+"', '"+aP+"', '"+aM+"', '"+fechNac+"'"
            + ", '"+tel+"', '"+sexo+"','"+school+"', "
        ...
        try{
            Conexion cx = new Conexion();
            String sql = "INSERT INTO personal VALUES('1','"+contra+"', '"+cuenta+"');";
